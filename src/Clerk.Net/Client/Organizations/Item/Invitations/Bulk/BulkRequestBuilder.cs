...
namespace Clerk.Net.Client.Organizations.Item.Invitations.Bulk
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.BulkRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Clerk.Net.Client.Models.OrganizationInvitations?> PostAsync(List<global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.Bulk> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Clerk.Net.Client.Models.OrganizationInvitations> PostAsync(List<global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.Bulk> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(List<global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.Bulk> body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(List<global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.Bulk> body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.BulkRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.BulkRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Clerk.Net.Client.Organizations.Item.Invitations.Bulk.BulkRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
