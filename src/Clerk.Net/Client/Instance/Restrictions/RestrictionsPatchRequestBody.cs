...
namespace Clerk.Net.Client.Instance.Restrictions
{
    ...
    public partial class RestrictionsPatchRequestBody : IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Instance.Restrictions.RestrictionsPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Clerk.Net.Client.Instance.Restrictions.RestrictionsPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Clerk.Net.Client.Instance.Restrictions.RestrictionsPatchRequestBody();
        }
        /// <summary>
