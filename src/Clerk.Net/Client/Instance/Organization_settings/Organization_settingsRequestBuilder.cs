...
namespace Clerk.Net.Client.Instance.Organization_settings
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<global::Clerk.Net.Client.Models.OrganizationSettings> PatchAsync(global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Clerk.Net.Client.Models.OrganizationSettings>(requestInfo, global::Clerk.Net.Client.Models.OrganizationSettings.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Updates the organization settings of the instance
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Clerk.Net.Client.Instance.Organization_settings.Organization_settingsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
