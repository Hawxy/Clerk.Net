...
namespace Clerk.Net.Client.Waitlist_entries
{
    ...
    public partial class Waitlist_entriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public Waitlist_entriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/waitlist_entries", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Clerk.Net.Client.Waitlist_entries.Waitlist_entriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Waitlist_entriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/waitlist_entries", rawUrl)
        {
        }
        /// <summary>
