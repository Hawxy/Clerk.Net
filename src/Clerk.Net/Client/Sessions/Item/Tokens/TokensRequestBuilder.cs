...
namespace Clerk.Net.Client.Sessions.Item.Tokens
{
    ...
    public partial class TokensRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostResponse"/></returns>
...
#nullable enable
        public async Task<global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostResponse?> PostAsync(global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostResponse> PostAsync(global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostResponse>(requestInfo, global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a session JSON Web Token (JWT) based on a session.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Clerk.Net.Client.Sessions.Item.Tokens.TokensPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Sessions.Item.Tokens.TokensRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Clerk.Net.Client.Sessions.Item.Tokens.TokensRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Clerk.Net.Client.Sessions.Item.Tokens.TokensRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
