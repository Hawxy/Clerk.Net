...
namespace Clerk.Net.Client.Sessions.Item.Verify
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Clerk.Net.Client.Sessions.Item.Verify.VerifyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Clerk.Net.Client.Models.Session?> PostAsync(global::Clerk.Net.Client.Sessions.Item.Verify.VerifyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Clerk.Net.Client.Models.Session> PostAsync(global::Clerk.Net.Client.Sessions.Item.Verify.VerifyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Clerk.Net.Client.Sessions.Item.Verify.VerifyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Clerk.Net.Client.Sessions.Item.Verify.VerifyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Sessions.Item.Verify.VerifyRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::Clerk.Net.Client.Sessions.Item.Verify.VerifyRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Clerk.Net.Client.Sessions.Item.Verify.VerifyRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
