...
using System;
namespace Clerk.Net.Client.Sessions.Item
{
    /// <summary>
    ...
    public partial class WithSession_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Clerk.Net.Client.Sessions.Item.Refresh.RefreshRequestBuilder Refresh
        {
            get => new global::Clerk.Net.Client.Sessions.Item.Refresh.RefreshRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The revoke property</summary>
        public global::Clerk.Net.Client.Sessions.Item.Revoke.RevokeRequestBuilder Revoke
        {
            get => new global::Clerk.Net.Client.Sessions.Item.Revoke.RevokeRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable enable
        public async Task<global::Clerk.Net.Client.Models.Session?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Clerk.Net.Client.Models.Session> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Clerk.Net.Client.Sessions.Item.WithSession_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Clerk.Net.Client.Sessions.Item.WithSession_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
