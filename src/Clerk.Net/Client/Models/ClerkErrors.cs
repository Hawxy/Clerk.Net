...
namespace Clerk.Net.Client.Models {
    public class ClerkErrors : ApiException, IAdditionalDataHolder, IParsable {
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"meta", n => { Meta = n.GetObjectValue<ClerkErrors_meta>(ClerkErrors_meta.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ClerkError>("errors", Errors);
            writer.WriteObjectValue<ClerkErrors_meta>("meta", Meta);
