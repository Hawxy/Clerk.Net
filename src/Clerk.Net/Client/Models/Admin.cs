...
namespace Clerk.Net.Client.Models {
    public class Admin : IParsable {
        ...
        public Admin_status? Status { get; set; }
        /// <summary>The strategy property</summary>
        public Admin_strategy? Strategy { get; set; }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"status", n => { Status = n.GetEnumValue<Admin_status>(); } },
                {"strategy", n => { Strategy = n.GetEnumValue<Admin_strategy>(); } },
            };
        }
        /// <summary>
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<Admin_status>("status", Status);
            writer.WriteEnumValue<Admin_strategy>("strategy", Strategy);
        }
    }
}
