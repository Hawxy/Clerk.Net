...
namespace Clerk.Net.Client.Models {
    public class ProxyCheck : IParsable 
    {
...
#nullable restore
        ...
        public ProxyCheck_object? Object { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ProxyCheck"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ProxyCheck CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"object", n => { Object = n.GetEnumValue<ProxyCheck_object>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ProxyCheck_object>("object", Object);
