...
using Clerk.Net.Client.Clients.Handshake_payload;
...
namespace Clerk.Net.Client.Clients
{
    ...
    {
        /// <summary>The handshake_payload property</summary>
        [Obsolete("")]
        public global::Clerk.Net.Client.Clients.Handshake_payload.Handshake_payloadRequestBuilder HandshakePayload
        {
            get => new global::Clerk.Net.Client.Clients.Handshake_payload.Handshake_payloadRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public ClientsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/clients{?limit*,offset*,paginated*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Clerk.Net.Client.Clients.ClientsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClientsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/clients{?limit*,offset*,paginated*}", rawUrl)
        {
        }
        /// <summary>
