...
namespace Clerk.Net.Client.Email_addresses
{
    ...
    public partial class Email_addressesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Clerk.Net.Client.Email_addresses.Item.WithEmail_address_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("email_address_id", position);
                return new global::Clerk.Net.Client.Email_addresses.Item.WithEmail_address_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Clerk.Net.Client.Email_addresses.Email_addressesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Clerk.Net.Client.Models.EmailAddress?> PostAsync(global::Clerk.Net.Client.Email_addresses.Email_addressesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Clerk.Net.Client.Models.EmailAddress> PostAsync(global::Clerk.Net.Client.Email_addresses.Email_addressesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Clerk.Net.Client.Email_addresses.Email_addressesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Clerk.Net.Client.Email_addresses.Email_addressesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Clerk.Net.Client.Email_addresses.Email_addressesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Clerk.Net.Client.Email_addresses.Email_addressesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Clerk.Net.Client.Email_addresses.Email_addressesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
