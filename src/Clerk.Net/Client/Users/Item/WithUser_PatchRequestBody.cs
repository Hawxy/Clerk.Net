...
namespace Clerk.Net.Client.Users.Item {
    public class WithUser_PatchRequestBody : IParsable {
...
#nullable restore
        ...
        public WithUser_PatchRequestBody_password_hasher? PasswordHasher { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public WithUser_PatchRequestBody_private_metadata? PrivateMetadata { get; set; }
#nullable restore
#else
        public WithUser_PatchRequestBody_private_metadata PrivateMetadata { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public WithUser_PatchRequestBody_public_metadata? PublicMetadata { get; set; }
#nullable restore
#else
        public WithUser_PatchRequestBody_public_metadata PublicMetadata { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public WithUser_PatchRequestBody_unsafe_metadata? UnsafeMetadata { get; set; }
#nullable restore
#else
        public WithUser_PatchRequestBody_unsafe_metadata UnsafeMetadata { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"password_hasher", n => { PasswordHasher = n.GetEnumValue<WithUser_PatchRequestBody_password_hasher>(); } },
                ...
                {"private_metadata", n => { PrivateMetadata = n.GetObjectValue<WithUser_PatchRequestBody_private_metadata>(WithUser_PatchRequestBody_private_metadata.CreateFromDiscriminatorValue); } },
                {"profile_image_id", n => { ProfileImageId = n.GetStringValue(); } },
                {"public_metadata", n => { PublicMetadata = n.GetObjectValue<WithUser_PatchRequestBody_public_metadata>(WithUser_PatchRequestBody_public_metadata.CreateFromDiscriminatorValue); } },
                ...
                {"unsafe_metadata", n => { UnsafeMetadata = n.GetObjectValue<WithUser_PatchRequestBody_unsafe_metadata>(WithUser_PatchRequestBody_unsafe_metadata.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteEnumValue<WithUser_PatchRequestBody_password_hasher>("password_hasher", PasswordHasher);
            ...
            writer.WriteObjectValue<WithUser_PatchRequestBody_private_metadata>("private_metadata", PrivateMetadata);
            writer.WriteStringValue("profile_image_id", ProfileImageId);
            writer.WriteObjectValue<WithUser_PatchRequestBody_public_metadata>("public_metadata", PublicMetadata);
            ...
            writer.WriteObjectValue<WithUser_PatchRequestBody_unsafe_metadata>("unsafe_metadata", UnsafeMetadata);
